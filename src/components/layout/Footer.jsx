      ...
      <div className="section-padding mx-auto max-w-7xl py-12">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div className="text-center md:text-left">
            <p className="text-lg font-semibold text-text">{personalInfo.name}</p>
          ...
          <div className="flex gap-4">
            <a
              ...
              aria-label="GitHub"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-border text-muted transition-colors hover:border-white/20 hover:text-text"
            >
        ...
        <div className="mt-10 border-t border-border pt-8 text-center">
          <p className="text-xs text-muted">
            © {year} {personalInfo.name}. Crafted with React, Three.js & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
